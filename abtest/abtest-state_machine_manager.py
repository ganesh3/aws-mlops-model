...
sagemaker_role = 'arn:aws:iam::568423094306:role/LabStack-db2fb1cf-2b19-49d0-ac04-8bc-SageMakerRole-1K57KN5HUJM8F'
workflow_role = 'arn:aws:iam::568423094306:role/LabStack-db2fb1cf-2b19-49d0-ac04-StepFunctionsRole-1UGSLWD0R8CJH'
ecr_ArnA = 'latesta'
ecr_ArnB = 'latestb'
state_machine_arn = 'arn:aws:states:us-west-2:568423094306:stateMachine:trainingStateMachine-H8eKlWnBrmTB'
state_machine_name = 'trainingStateMachine-H8eKlWnBrmTB'
dynamoDBTable = 'LabStack-db2fb1cf-2b19-49d0-ac04-8bc7593eaa5e-8BmK3DCrFMWqqdbFcUyxnh-2-DynamoDBTable-17XTCLJLCT29Z'
endpoint_wait_lambda = 'arn:aws:lambda:us-west-2:568423094306:function:LabStack-db2fb1cf-2b19-49d0-ac0-endpointWaitLambda-WjSnT19yjb0a'
model_test_step = 'arn:aws:lambda:us-west-2:568423094306:function:LabStack-db2fb1cf-2b19-49d0-ac04-8-modelTestLambda-Y2zvbWTnJwOX'
multivariant_test_step = 'arn:aws:lambda:us-west-2:568423094306:function:LabStack-db2fb1cf-2b19-49d0-multiVariantTestLambda-ADu0vucIms1I'
endpoint_create_lambda = 'arn:aws:lambda:us-west-2:568423094306:function:LabStack-db2fb1cf-2b19-49d0-a-createEndpointLambda-wwNuhGNU0vDu'
destination_capture_bucket = 's3://labstack-db2fb1cf-2b19-49d0-a-modelartifactbucket-8gmmn42xzco1/capturedata/'
model_bucketA = 's3://labstack-db2fb1cf-2b19-49d0-a-modelartifactbucket-8gmmn42xzco1/modelA/'
model_bucketB = 's3://labstack-db2fb1cf-2b19-49d0-a-modelartifactbucket-8gmmn42xzco1/modelB/'
kms_key = '27579613-10a4-4159-8764-f081ccf9d496'
...
#     endpoint_config_name=event_input['ModelA'],
#     model_name=event_input['ModelA'],
...
# endpoint_create_step = steps.EndpointStep(
#     "Create Endpoint",
...
# Chain the steps together to generate a full Amazon Step Function
